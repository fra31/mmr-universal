...
def create_hps_str(hps):
    ...
    if hps.p in ['2', 'inf']:
      ...
      hyperparam_str = ("dataset={} nn_type={} p_norm={} lmbd_l1={} lmbd_linf={} gamma_l1={} gamma_linf={}"). \
          format(hps.dataset, hps.nn_type, hps.p, hps.lmbd_l1, hps.lmbd_linf, hps.gamma_l1, hps.gamma_linf)
...
def get_n_total_hidden_units(nn_type, n_hs, height_in):
    ...
    elif nn_type == 'cnn_lenet':
        return 8*height_in**2 + 16 * h1 ** 2 + 32 * h2 ** 2 + 100 # MNIST/FMNIST: 11076
    else:
